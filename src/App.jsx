    ...
    const loadData = async () => {
      try {
        ...
        const deckFiles = [
          ...
          "/data/unidad1-introduccion.json",
          "/data/unidad2-actividades-archivos.json",
          "/data/unidad2-actividades-discos.json",
          "/data/unidad2-actividades.json",
          "/data/unidad2-autoeval-archivos.json",
          "/data/unidad2-autoeval-discos.json",
          "/data/unidad2-autoevaluacion.json",
          "/data/unidad2-discos.json",
          "/data/unidad2-parte1.json",
          "/data/unidad2-parte2.json",
          "/data/unidad2-trabajo-archivos.json",
          "/data/unidad3-actividades-cuentas.json",
          "/data/unidad3-actividades-ldap.json",
          "/data/unidad3-actividades-recursos.json",
          "/data/unidad3-autoeval-cuentas.json",
          "/data/unidad3-autoeval-ldap.json",
          "/data/unidad3-autoeval-recursos.json",
          "/data/unidad3-cuentas-grupos.json",
          "/data/unidad3-ldap.json",
          "/data/unidad3-recursos-dominio.json",
          "/data/unidad3-redes-linux.json",
          "/data/unidad4-actividades.json",
          "/data/unidad4-autoeval.json",
          "/data/unidad4-seguridad.json",
        ];
